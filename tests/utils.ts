...
export const MOCK_SESSION_1_RESPONSE_1: ChatResponse = {
	...
	message: {
		role: "assistant",
		content: "I am unable to provide subjective or speculative information, including fight outcomes between individuals."
	},
	done: true,
	done_reason: "stop",
...
export const MOCK_SESSION_1_RESPONSE_2: ChatResponse = {
	...
	message: {
		role: "assistant",
		content: "No problem! If you have any other questions or would like to discuss something else, feel free to ask."
	},
	done: true,
	done_reason: "stop",
...
export const MOCK_SESSION_2_RESPONSE_1: ChatResponse = {
	...
	message: {
		role: "assistant",
		content: "The fox says various things, such as \"ring-a-ding-ding,\" \"bada bing-bing\" and \"higglety-pigglety pop."
	},
	done: true,
	done_reason: "stop",
...
export const MOCK_SESSION_WITH_KNOWLEDGE_RESPONSE_1: ChatResponse = {
	...
	message: {
		role: "assistant",
		content: "Wally has been approved to work from home and plans to have a chatbot answer his emails and text messages. However, Dilbert expresses concern that the automated responses may not sound like him, rendering them useless."
	},
	done: true,
	done_reason: "stop",
	total_duration: 8048965583,
