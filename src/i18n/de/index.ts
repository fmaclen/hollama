...
const de = {
	...
	openaiSyncFailed:
		'Verbindung zu OpenAI fehlgeschlagen. Überprüfen Sie Ihren API-Schlüssel oder die Netzwerkverbindung',
	openaiSyncSuccessful:
		'Synchronisation erfolgreich. OpenAI-Modelle sind jetzt in Sitzungen verfügbar',
