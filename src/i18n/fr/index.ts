...
const fr = {
	...
	apiKey: 'Clé API',
	areYouSureYouWantToDeleteAllKnowledge: 'Êtes-vous sûr de vouloir supprimer toute la connaissance?',
	...
	checkBrowserExtensions: "Vérifiez également qu'aucune extension de navigateur ne bloque la connexionr",
